...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    ...
    enum: [
      ...
      'campaign_more_info_required', 'campaign_document_verified',
      'campaign_document_rejected', 'campaign_verified'
    ],
    required: true
  },
  title: {
  ...
  data: {
    ...
    documentId: { type: mongoose.Schema.Types.ObjectId, ref: 'CampaignDocument' },
