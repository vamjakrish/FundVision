...
export const adminAPI = {
  ...
  getVerificationQueue: (params) => api.get('/admin/campaigns/verification-queue', { params }),
  verifyDocument: (docId, data) => api.patch(`/admin/documents/${docId}/verify`, data),
  requestMoreInfo: (campaignId, data) => api.post(`/admin/campaigns/${campaignId}/request-info`, data),
  verifyCampaignStatus: (campaignId, data) => api.patch(`/admin/campaigns/${campaignId}/verify-status`, data),
...
export const proofAPI = {
  uploadProof: (campaignId, formData) => api.post(`/campaigns/${campaignId}/documents`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  getProofs: (campaignId) => api.get(`/campaigns/${campaignId}/documents`),
  deleteProof: (campaignId, docId) => api.delete(`/campaigns/${campaignId}/documents/${docId}`),
  updateFundUtilization: (campaignId, data) => api.put(`/campaigns/${campaignId}/fund-utilization`, data),
  getPublicProofs: (campaignId) => api.get(`/campaigns/${campaignId}/proofs/public`),
  getSecurePreview: (docId) => api.get(`/documents/${docId}/secure-preview`),
  submitVerification: (campaignId, data = {}) => api.post(`/campaigns/${campaignId}/submit-verification`, data),
};
